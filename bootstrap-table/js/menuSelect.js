        ...
        columns:[
...

            {
                ...
                formatter:function(value,row,index){
                    ...
                    let d='<a href="javascript:void(0);" onclick="removeData(\''+row.menuId+'\')">删除</a>'
                    let m='<a href="javascript:void(0);" onclick="modifyGoods(\''+row.menuId+'\',\''
                        +row.menuName+'\',\''+row.menuHref+'\')">修改</a>'
...
function modifyGoods(menuId,menuName,menuHref,){
    // var dataJSON={};
    ...
    localStorage.setItem("menuId",menuId);
        ...
        layer.open({
            ...
            content:'../main/caidanUpdate.html',//设置弹出层打开的页面
            //弹出层页面成功打开后，的设置
